...
Different Agency implementations have distinct wrap, unwrap function logic, and different oracleFunction. Users can customize the currency, initial premium, fee receiving address, fee rate, etc., to initialize the Agency contract. 
